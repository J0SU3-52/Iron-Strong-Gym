...
<body>
    ...
    <?php $page = 'eliminate-routine.php';
    include 'includes/sidebar.php' ?>


    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.php" title="ir a inicio" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="routine.php" class="tip-bottom">Rutinas personalizadas</a> <a href="search-routines-remove.php" class="current">Eliminar rutinas</a>
            </div>
