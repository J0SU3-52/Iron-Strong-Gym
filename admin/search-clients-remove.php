    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.php" title="ir a inicio" class="tip-bottom"><i class="fas fa-home"></i> Home</a>
                <a href="remove-clients.php">Eliminar Clientes</a>
                <a href="#" class="current">Resultados Busqueda</a>
            </div>
            <h1 class="text-center">Eliminar Clientes <i class="fas fa-users"></i></h1>
        </div>
        <div class="container-fluid">
                ...
                <div class="span12">
                    ...
                    <div class='widget-box'>
                        <div class='widget-title'> <span class='icon'> <i class='fas fa-th'></i> </span>
                            ...
                            <form id="custom-search-form" role="search" method="POST" action="search-clients-remove.php" class="form-search form-horizontal pull-right">
                        ...
                        <div class='widget-content nopadding'>
                            ...
                            $search = $_POST['search'];
                            $cnt = 1;
                            $qry = "select * from members where fullname like '%$search%' or fullname or contact like '%$search%'";
            ...
            <a class='btn btn-danger btn-big'  href='remove-clients.php'>Regresar</a> </div>'";
                            } else {
        ...
        <tr>
                ...
                <td><div class='text-center'><a href='actions/delete-client.php?id=" . $row['user_id'] . "' style='color:#F66;'><i class='fas fa-trash'></i> Eliminar</a></div></td>
