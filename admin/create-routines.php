...
<head>
  ...
  <link rel="stylesheet" href="../css/custom-styles.css"> <!-- Archivo CSS personalizado -->
...
<body>
  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb">
        ...
        <a href="create-routines.php" class="current">Crear Rutina Personalizada </a>
      </div>
      <h1 class="text-center">Crear Rutina Personalizada <i class="fas fa-dumbbell fas-fa-lg"></i></h1>
    </div>
      ...
      <form id="routineForm" action="routine-handler.php" method="POST" class="form-horizontal custom-form" onsubmit="updateHiddenInput()">
                ...
                <div class="form-container">
                  <div class="form-row">
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input type="text" class="span3" name="fullname" placeholder="Ingrese su nombre con apellidos" required />
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label">Nombre de la rutina:</label>
                      <div class="controls">
                        <input type="text" class="span3" name="routine_name" placeholder="Agregue nombre de su rutina" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-row">
                    <div class="control-group full-width">
                      ...
                      <div class="controls">
                        <input type="email" class="span3" name="gmail" placeholder="Agregue su correo electrónico" required />
                      </div>
                    </div>
                  </div>
                ...
                <div class="form-container">
                  <div class="form-row">
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input type="date" name="dor" class="span3" required />
                      </div>
                    </div>
                  </div>
                  <div class="form-row">
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <label class="radio-label"><input type="radio" value="Normal" name="services" required /> Normal </label>
                        <label class="radio-label"><input type="radio" value="Estudiante" name="services" required /> Estudiante </label>
                        <label class="radio-label"><input type="radio" value="Cardio" name="services" required /> Cardio </label>
                        <label class="radio-label"><input type="radio" value="Normal + Cardio" name="services" required /> Normal + Cardio </label>
                        <label class="radio-label"><input type="radio" value="Estudiante + Cardio" name="services" required /> Estudiante + Cardio </label>
                      </div>
                    </div>
                  </div>

                  <input type="hidden" name="ejerciciosSeleccionados" id="ejerciciosSeleccionados" value="">
        ...
        <div class="day-container">
          ...
          <div class="control-group full-width">
            ...
            <div class="controls">
              <input type="text" class="span3" name="title_routineday_Lunes" placeholder="ejem, Pecho y Espalda" />
            </div>
          </div>
          ...
          <div class="selected-exercises" id="selected-exercises-Lunes" style="display: none;"></div>
        </div>
        ...
        <div class="day-container">
          ...
          <div class="control-group full-width">
            ...
            <div class="controls">
              <input type="text" class="span3" name="title_routineday_Tuesday" placeholder="ejem, Piernas y Glúteos" />
            </div>
          </div>
          ...
          <div class="selected-exercises" id="selected-exercises-Martes" style="display: none;"></div>
        </div>
        ...
        <div class="day-container">
          ...
          <div class="control-group full-width">
            <label class="control-label">Título</label>
            <div class="controls">
              <input type="text" class="span3" name="title_routineday_Wednesday" placeholder="ejem, Pecho y Espalda" />
            </div>
          </div>
          ...
          <div class="selected-exercises" id="selected-exercises-Miercoles" style="display: none;"></div>
        </div>
        ...
        <div class="day-container">
          ...
          <div class="control-group full-width">
            <label class="control-label">Título</label>
            <div class="controls">
              <input type="text" class="span3" name="title_routineday_Thursday" placeholder="ejem, Pecho y Espalda" />
            </div>
          </div>
          ...
          <div class="selected-exercises" id="selected-exercises-Jueves" style="display: none;"></div>
        </div>
        ...
        <div class="day-container">
          ...
          <div class="control-group full-width">
            <label class="control-label">Título</label>
            <div class="controls">
              <input type="text" class="span3" name="title_routineday_Friday" placeholder="ejem, Pecho y Espalda" />
            </div>
          </div>
          ...
          <div type="button" class="selected-exercises" id="selected-exercises-Viernes" style="display: none;"></div>
        </div>
        ...
        <div class="day-container">
          ...
          <div class="control-group full-width">
            <label class="control-label">Título</label>
            <div class="controls">
              <input type="text" class="span3" name="title_routineday_Saturday" placeholder="ejem, Pecho y Espalda" />
            </div>
          </div>
          ...
          <div type="button" class="selected-exercises" id="selected-exercises-Sabado" style="display: none;"></div>
        </div>
  ...
  <script>
    ...
    function toggleExercise(day, exercise, button) {
      if (!selectedExercises[day]) {
        selectedExercises[day] = [];
      }
      const index = selectedExercises[day].indexOf(exercise);
      if (index > -1) {
        selectedExercises[day].splice(index, 1);
        button.classList.remove('selected');
      } else {
        selectedExercises[day].push(exercise);
