...
<body>
    ...
    <div id="content">
        <div id="content-header">
            ...
            <h1 class="text-center">Clientes Expirados 🔴 <!-- <i class="fas fa-eye"></i></h1> -->
        </div>
                ...
                <div class="span12">
                    <div class='widget-box'>
                        ...
                        <div>
                            <?php
                            include "dbcon.php";
                            $qry = "SELECT * FROM members WHERE status='Expired'";
                            $cnt = 1;
                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class='text-center'><?php if ($row['status'] == 'Expired') {
                                        ...
                                        <td>
                                            <div class='text-center'><a href='actions/delete-client.php?id=<?php echo $row['user_id']; ?>' style='color:#F66;'><i class='fas fa-trash'></i> Eliminar</a>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
