...
<body>
  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="index.php" title="ir a inicio" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="remove-equipment.php" class="current">Quitar equipo</a> </div>
      <h1 class="text-center">Quitar Equipo <i class="fas fa-cogs"></i></h1>
    </div>
          ...
          <div class='widget-box'>
            ...
            <div class='widget-content nopadding'>
              ...
              while ($row = mysqli_fetch_array($result)) {
                ...
                <td><div class='text-center'><a href='actions/delete-equipment.php?id=" . $row['id'] . "' style='color:#F66;'><i class='fas fa-trash'></i> Eliminar</a></div></td>
