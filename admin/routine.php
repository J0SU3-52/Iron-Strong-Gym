  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="index.php" title="ir a inicio" class="tip-bottom"><i class="fas fa-home"></i> Home</a>
        <a href="routine.php" class="current"> Rutinas Personalizadas</a>
      </div>
      <h1 class="text-center">Rutinas Personalizadas <i class="fas fa-dumbbell"></i> </h1>
    </div>
    <div class='widget-box'>
      <div class='widget-title'>
        ...
        <div class="form-search-wrapper">
          <form id="custom-search-form" role="search" method="POST" action="search-routines.php" class="form-search">
