...
<body>
    ...
    <div id="content">
        <div id="content-header">
            ...
            <h1 class="text-center">Rutinas Personalizadas <i class="fas fa-users"></i></h1>
        </div>
        <div class="container-fluid">
                ...
                <div class="span12">
                    ...
                    <div class='widget-box'>
                        <div class='widget-title'> <span class='icon'> <i class='fas fa-th'></i> </span>
                            ...
                            <form id="custom-search-form" role="search" method="POST" action="search-routines.php" class="form-search form-horizontal pull-right">
                        ...
                        <div class='widget-content nopadding'>
                            ...
                            $search = $_POST['search'];
                            $cnt = 1;
                            $qry = "SELECT * FROM routines WHERE fullname LIKE '%$search%' OR routine_id LIKE '%$search%'";
            ...
            <a class='btn btn-danger btn-big'  href='routine.php'>Regresar</a> </div>'";
                            } else {
        ...
        <thead>
          <tr>
                ...
                <td><div class='text-center'>" . $row['services'] . "</div></td>
                 <td>
                    <div class='text-center'><a href='generate-routine-pdf.php?id=" . $row['routine_id'] . "' target='_blank'><button class='btn btn-success btn'> Ver Rutina</button></a></div>
                  </td>
