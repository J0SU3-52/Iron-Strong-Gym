    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.php" title="ir a inicio" class="tip-bottom"><i class="fas fa-home"></i> Home</a>
                <a href="view-attendance.php">Lista de Asistencia</a>
                <a href="#" class="current">Resultados Busqueda</a>
            </div>
            <h1 class="text-center">Lista de Asistencia <i class="fa-regular fa-calendar-days"></i></h1>
        </div>
        <div class="container-fluid">
            ...
            <a class='btn btn-danger btn-big'  href='view-attendance.php'>Regresar</a> </div>'";
                            } else {
        ...
        <thead>
                        ...
                        <td><div class='text-center'><a href='calendar-attendance.php?id=" . $row['user_id'] . "'><button class='btn btn-success'>Ver Asistencia</button></a></div></td>
