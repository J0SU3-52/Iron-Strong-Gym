    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.php" title="ir a inicio" class="tip-bottom"><i class="fas fa-home"></i> Home</a>
                <a href="clients.php">Clientes registrados</a>
                <a href="#" class="current">Resultados Busqueda</a>
            </div>
            <h1 class="text-center">Clientes Registrados <i class="fas fa-users"></i></h1>
        </div>
        <div class="container-fluid">
            ...
            <a class='btn btn-danger btn-big'  href='clients.php'>Regresar</a> </div>'";
                            } else {
