...
<body>
  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="index.php" title="ir a inicio" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="member-status.php" class="current">Estado</a> </div>
      <h1 class="text-center">Estado del Cliente <i class="fas fa-eye"></i></h1>
    </div>
