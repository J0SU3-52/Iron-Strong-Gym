...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="ir a inicio" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="customer-progress.php">Progreso</a> <a href="#" class="current">Search Results</a> </div>
    <h1 class="text-center">Actualizar el progreso del cliente <i class="fas fa-signal"></i></h1>
  </div>
        ...
        <thead>
          <tr>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='update-progress.php?id=".$row['user_id']."'><button class='btn btn-warning btn-mini'>Progreso de actualización</button></a></div></td>
